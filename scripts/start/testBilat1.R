...
cfg$title   <- paste0("13121BilatImportRatio_Default")

#start_run(cfg=cfg)


cfg$title   <- paste0("1312BilatImportRatio_RotConstraint_TarfsCorr")
...
cfg$title   <- paste0("1312BilatImportRatio_NoTariff")
