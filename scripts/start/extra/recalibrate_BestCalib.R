...
realizations <- c("sticky_feb18","per_ton_fao_may22") # "per_ton_fao_may22","sticky_labor" is very similar to sticky_feb18. No extra calibration needed.
type <- NULL
...
for (b in best){
    ...
    start_run(cfg)
    magpie4::submitCalibration(paste("H12-CUBR2", r, b, sep = "_"))
