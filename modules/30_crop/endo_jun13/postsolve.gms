...
$ifthen "%c30_protect_crop%" == "protect" p30_max_protection(j)$(vm_land.l(j,"crop")) = vm_land.l(j,"crop")*(1-s30_perc_protected/100);
$endif
$ifthen "%c30_protect_crop%" == "protect" p30_max_protection_area(j,kcr,w)$(vm_area.l(j,kcr,w)) = vm_area.l(j,kcr,w)*(1-s30_perc_protected/100);
$endif
);
