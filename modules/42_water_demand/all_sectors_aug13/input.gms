...
$offdelim
;
*$if "%c42_watdem_scenario%" == "nocc" f42_wat_req_kve(t_nocc,j,kve) = f42_wat_req_kve("y2020",j,kve);
$if "%c42_watdem_scenario%" == "nocc" f42_wat_req_kve(t_nocc,j,kve) = f42_wat_req_kve("y1995",j,kve);
...
/
;
*$if "%c42_watdem_scenario%" == "nocc" f42_env_flows(t_nocc,j) = f42_env_flows("y2020",j);
$if "%c42_watdem_scenario%" == "nocc" f42_env_flows(t_nocc,j) = f42_env_flows("y1995",j);
