...
equations
 ...
 q38_cost_prod_inv(i,kcr)              Regional investment costs in capital (mio USD05MER)
 q38_investment_immobile(j,kcr)    Cellular immobile investments into farm capital   (mio USD05MER)
 q38_investment_mobile(j,kcr)          Cellular mobile investments into farm capital   (mio USD05MER)
;
...
positive variables
 ...
 v38_investment_mobile(j,kcr)              Investment costs in mobile farm capital (mio USD05MER per yr)
;
...
parameters
 ...
 p38_capital_mobile(t,j,kcr)               Preexisting mobile capital stocks before investment (mio USD05MER)
