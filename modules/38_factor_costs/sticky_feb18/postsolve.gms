...
p38_capital_immobile(t+1,j,kcr) =(p38_capital_immobile_t(j,kcr) + v38_investment_immobile.l(j,kcr));
*                  (1-s38_depreciation_rate)**(m_year(t+1)-m_year(t));

p38_capital_mobile(t+1,j) =(p38_capital_mobile_t(j) + v38_investment_mobile.l(j));
*                  (1-s38_depreciation_rate)**(m_year(t+1)-m_year(t));
