...
i38_capital_need(i,kcr,"mobile") = f38_fac_req(i,kcr)  * f38_capital_cost_share(i,kcr) / pm_interest(t,i) * (1-s38_immobile);
i38_capital_need(i,kcr,"immobile") = f38_fac_req(i,kcr) *f38_capital_cost_share(i,kcr) / pm_interest(t,i) * s38_immobile;

if (ord(t) = 1,

i38_variable_costs(i2,kcr) = f38_fac_req(i2,kcr)  * (1-f38_capital_cost_share(i2,kcr)) * (1-s38_mi_start);
